    ...
    const fetchOrders = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:8000/soldProduct/${localStorage.getItem('userId')}`,
          {
            method: 'GET',
            headers: {
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        >
          {orders.length === 0 ? (
            <p>No product orders found in your inventory</p>
          ) : (
                  ...
                  <CardActionArea>
                    ...
                    <CardContent style={{ textAlign: 'start' }}>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          fetch(
                            `http://localhost:8000/soldProduct/${order._id}`,
                            {
                              method: 'DELETE',
                              headers: {
                                'Content-Type': 'application/json',
      ...
      {loading ? (
        ...
        >
          {animal?.length === 0 ? (
            <p>No animals orders found in your inventory</p>
          ) : (
